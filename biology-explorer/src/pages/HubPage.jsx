...
export default function HubPage() {
   ...
   *
   * Every module contributes equally for now.
   * Later we can make this more intelligent based on
   * individual lab stages, quiz scores, etc.
   */
  ...
  return (
    <div className="pt-24 px-6 max-w-5xl mx-auto min-h-screen relative overflow-hidden transition-colors duration-0">
      ...
      <header
        ...
        ref={headerRef}
      >
        <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4 text-slate-900 dark:text-slate-50">
          {hub.title}
        </h1>
      ...
      >
        {hub.modules.map((module, index) => {
          const ModuleComponent =
            getModuleComponent(module.type);
